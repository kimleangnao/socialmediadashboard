...
const UpdateCardCommentChildren = () => {
    return(
     
        <div className="dashboard_update_display_card_details_comments_comment">
            <div className="dashboard_update_display_card_details_comments_comment_connect">
                <div className="dashboard_update_display_card_details_comments_comment_connect_box dashboard_update_display_card_details_comments_comment_connect_box-1">
                
                </div>
                <div className="dashboard_update_display_card_details_comments_comment_connect_box dashboard_update_display_card_details_comments_comment_connect_box-2">
                
                </div>
                <div className="dashboard_update_display_card_details_comments_comment_connect_box dashboard_update_display_card_details_comments_comment_connect_box-3">
                
                </div>
                <div className="dashboard_update_display_card_details_comments_comment_connect_box dashboard_update_display_card_details_comments_comment_connect_box-4">
...
export default UpdateCardCommentChildren;